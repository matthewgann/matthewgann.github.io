        ...
        <ScrollReveal>
          <div className="max-w-4xl mx-auto px-6 py-14">
            ...
            <p className="text-sm leading-relaxed" style={{ color: "var(--text-muted)" }}>
              The writing and ideas on this site are my own. I use AI tools to support the process: brainstorming concepts, surfacing relevant literature to substantiate my points, and proofreading for grammar, spelling, and punctuation, and suggesting ways to improve clarity and flow. All suggestions are reviewed before publishing.
            </p>
          </div>
        </ScrollReveal>
      </section>
